        ...
        <div className='flex items-start lg:items-center flex-col py-4 gap-y-2  justify-start lg:justify-center'>
             <div className="flex lg:px-3 lg:px-0 capitalize gap-x-2 text-left lg:text-center items-center justify-start lg:justify-center">
                   ...
                   <div className='flex items-center lg:mr-20'>
                        <div className='flex bg-white items-center mr-2 p-2 w-12 h-12 rounded-lg'><AiOutlineMail className='w-12 h-12' /></div>
                        <div className=''>
                        <span className='font-Poppins text-base  text-white font-semibold' >Email</span><br></br>
                        <span className='font-Poppins text-sm tracking-widest text-white font-semibold' >inquiries@blockchainslc.com</span>
                        </div>
                    </div>
                   </Fade>
                       <Fade delay={500} right={true}>
                       <div className='flex items-center'>
                        <div className='flex bg-white items-center p-2 w-12 h-12 mr-2 rounded-lg'><BsTelephone className='w-10 h-10'/></div>
                            <div>
                            <span className='font-Poppins text-base text-white block font-semibold'>Phone</span>
                        <span className='font-Poppins text-sm tracking-widest text-white font-semibold' >(801) 960-2447 </span>
                            </div>
                        </div>
                       </Fade>
                    </div>
