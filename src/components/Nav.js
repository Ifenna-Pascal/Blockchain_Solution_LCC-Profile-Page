...
function Nav() {
  ...
  return (
    <nav className={`sticky top-0 ${setScrollNav ? "bg-black shadow-lg" : "bg-transparent"}   lg:container z-50 border-gray-200 px-2 sm:px-4 py-6`}>
        ...
        <div className="sm:hidden w-full md:block md:w-auto" id="mobile-menu">
