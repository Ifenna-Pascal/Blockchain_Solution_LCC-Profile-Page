...
function Nav() {
  ...
  return (
    <nav className={`sticky h-[7rem] top-0 ${scrollNav ? "bg-black" : "bg-transparent"}   lg:container z-50 border-gray-200`}>
        ...
        <ul className="flex flex-col mt-4 md:flex-row md:space-x-10 lg:space-x-14 opacity-80 sm:opacity-100 mx-auto md:w-full w-[90%]  md:mt-0 md:text-sm md:font-medium">
        <li>
