...
function Nav() {
  ...
  return (
    <nav className={`sticky h-[7rem] top-0 ${setScrollNav ? "bg-black shadow-2xl" : "bg-transparent"}   lg:container z-50 border-gray-200`}>
        <div className='w-[100%] h-full lg:container  sm:px-4 py-6 mx-auto'>
        <div className=" flex flex-wrap bg-black opacity-80 justify-between items-center">
         <Logo />
        ...
        <ul className="flex flex-col mt-4 md:flex-row md:space-x-10 lg:space-x-14 md:mt-0 md:text-sm md:font-medium">
        <li>
