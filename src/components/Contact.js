...
function Contact() {
  ...
  return (
    <div className="bg-black  my-24 lg:w-[90%] w-[95%] mx-auto" id="contact">
      <div className="md:w-full mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="md:flex-1  w-[95%] mx-auto  justify-items-start md:justify-start justify-center justify-self-start">
            ...
            <div className="text-white text-base font-Poppins mb-8 text-left">
              We'd love to hear about you and your project.{" "}
            </div>
            <form onSubmit={onSubmit}>
              ...
              <div className="grid gap-x-7  md:grid-cols-2 grid-cols-1 gap-y-4 md:gap-y-7">
                <input
                  ...
                  value={data.name}
                  name="name"
                  className="py-5 col-span-2 md:col-span-1 rounded-md px-5 md:text-lg tracking-wide text-gray-100 font-semibold bg-[#333333] font-Poppins"
                  placeholder="Name"
                  required
                />
                <input
                  ...
                  value={data.email}
                  name="email"
                  className="py-5 rounded-md px-5 md:text-lg col-span-2 md:col-span-1 tracking-wide text-gray-100 font-semibold bg-[#333333] font-Poppins"
                  placeholder="Email"
                  required
                />
                <div className="col-span-2">
                  <textarea
                    ...
                    value={data.message}
                    name="message"
                    className="py-5 md:h-[14rem] h-[8rem] rounded-md px-5 text-lg tracking-wide text-gray-100 bg-[#333333] font-semibold font-Poppins w-full"
                  ></textarea>
                </div>
                <div className="col-span-2 md:w-[70%] md:mx-auto md:items-center md:justify-center flex items-start justify-start">
                  <button className="bg-[#BE173F] md:justify-self-center md:-ml-0   md:w-[60%] mb-6 text-white text-lg font-Poppins px-10 py-4 rounded-lg">
