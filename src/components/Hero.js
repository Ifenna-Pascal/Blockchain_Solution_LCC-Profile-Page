...
function Hero() {
  return (
    <div className='mx-auto' style={{ height: "calc(90vh)"}}>
             <div style={{backgroundImage: `url(${bg})`, }} className='dark_bg w-[100%] h-full  mx-auto bg-no-repeat bg-cover'>
          <div className='py-12 mx-auto items-center w-full justify-center md:w-[85%] h-full  md:justify-between flex'>
            ...
            <div className='flex md:text-left text-center flex-col mb-10 md:mb-0 items-center md:items-start  flex-1 gap-y-4'>
                <div className="flex uppercase gap-x-2 items-center">
                    ...
                    <p className='font-normal -mt-1 capitalize text-white font-Poppins text-xl text-left md:w-[50%]'>Web and Blockchain Solutions</p>
                    <div className='flex flex-col items-start justify-start mt-6'><button className='bg-[#BE173F] w-full text-white text-lg font-Poppins px-16 py-4 rounded-lg'>  <Link to="contact" smooth={true} duration={500} offset={-84} spy={true} exact="true"> Contact Us </Link></button></div>
            </div>
            </Zoom>
      </div>
     </div>
